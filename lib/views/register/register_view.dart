          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                margin: const EdgeInsets.symmetric(vertical: 16),
                alignment: Alignment.center,
                child: Text('register'.tr, style: Get.textTheme.headline3?.copyWith(color: Colors.white)),
              ),
              BaseCardView(
                  margin:
                  const EdgeInsets.only(top: 12, bottom: 24, left: 4, right: 4),
                  corner: 24,
                  child: TextField(
              ...
              BaseCardView(
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        //   hoverColor: IColors.labelGreenColor,
                        //   text: 'get_otp_code'.tr, onPressed: () => controller.sendVerifyCode(),
                        // ),
                        suffixIcon: Container(
                          margin: const EdgeInsets.only(right: 16),
                          child: TextButton(
                            child: Text('get_otp_code'.tr, style: Get.textTheme.bodyText1?.copyWith(color: IColors.primarySwatch),),
              ...
              Container(
                ...
                child: BaseButton(
                  ...
                  child: Text('register'.tr, style: Get.textTheme.subtitle1?.copyWith(color: IColors.primarySwatch, fontWeight: FontWeight.bold),),
                ),
              ),
              Container(
                alignment: Alignment.center,
                child: TextButton(onPressed: () => controller.toLogin(), child: Text('go_login'.tr, style: Get.textTheme.subtitle2?.copyWith(color: Colors.white),)),
              ),
            ],
          ),
        ),
