...
class UpgradeLogic extends GetxController {
  ...
  bool get showBtns => downloadState.value == 0;
  ...
  String get btnStr {
    switch(downloadState.value) {
      ...
      default:
        return GetPlatform.isIOS ? 'begin_download_ios'.tr : 'begin_download_android'.tr;
    }
  }
  ...
  upgradeApp(UpgradeVersion upgradeVersion) {
    if (GetPlatform.isAndroid) {
      if(downloadState.value == 0 || downloadState.value == 3) {
        _downloadApk(upgradeVersion.downloadUrl!);
